        ...
        <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-6 sm:p-8">
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-4">
            ...
            <button
              ...
              className={`w-full mt-3 py-2.5 rounded-lg text-white font-medium bg-[oklch(70.4%_0.191_22.216)] hover:opacity-90 transition ${loadingAuth ? "opacity-70 cursor-not-allowed" : ""
                }`}
            >
              {loadingAuth
                ? isSignup
            ...
            <GoogleLogin
              ...
              render={(renderProps) => (
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-white border border-gray-200 rounded-lg hover:border-gray-300 hover:shadow-md transition-all duration-200 disabled:opacity-70 disabled:cursor-not-allowed group relative"
                >
                  {/* Loading Spinner */}
                  {loadingGoogle && (
                  ...
                  {/* Google Icon - hidden when loading */}
                  {!loadingGoogle && (
